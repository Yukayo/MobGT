...
def caculate_poi_distance(poi_coors):
    ...
    pickle.dump(sim_matrix, open('../../dataset/baseline_models_dataset/LSTPM/gowalla_distance.pkl', 'wb'))
    return sim_matrix
...
def train_network(network, num_epoch=40 ,batch_size = 32,criterion = None):
    ...
    output_df.to_csv("./output/gowalla_output_prednew.txt")
...
if __name__ == '__main__':
    ...
    data = pickle.load(open('../../dataset/baseline_models_dataset/LSTPM/gowalla.pk', 'rb'), encoding='iso-8859-1')
    ...
    poi_distance_matrix = pickle.load(open('../../dataset/baseline_models_dataset/LSTPM/gowalla_distance.pkl', 'rb'), encoding='iso-8859-1')
