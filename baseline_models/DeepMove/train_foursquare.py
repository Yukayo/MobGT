...
def run(args):
    ...
    if args.pretrain == 1:
        ...
        model.load_state_dict(torch.load("./exps/foursquare"+ "/res.m"))
...
def load_pretrained_model(config):
    res = json.load(open("./exps/foursquare" + "/res.txt"))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_name', type=str, default='tky')
    ...
    parser.add_argument('--data_path', type=str, default='../../dataset/baseline_models_dataset/DeepMove/')
    parser.add_argument('--save_path', type=str, default='./exps/foursquare/')
