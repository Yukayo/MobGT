...
def run(args):
    ...
    if args.pretrain == 1:
        ...
        model.load_state_dict(torch.load("./exps/toyota"+ "/res.m"))
...
def load_pretrained_model(config):
    res = json.load(open("./exps/toyota" + "/res.txt"))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_name', type=str, default='toyota')
    ...
    parser.add_argument('--save_path', type=str, default='./exps/toyota/')
