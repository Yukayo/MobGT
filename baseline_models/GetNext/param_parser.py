...
def parameter_parser():
    ...
    parser.add_argument('--data-adj-mtx',
                        type=str,
                        default='../../dataset/baseline_models_dataset/GetNext/toyota/graph_A.csv',
                        help='Graph adjacent path')
    parser.add_argument('--data-node-feats',
                        type=str,
                        default='../../dataset/baseline_models_dataset/GetNext/toyota/graph_X.csv',
                        help='Graph node features path')
    parser.add_argument('--data-train',
                        type=str,
                        default='../../dataset/baseline_models_dataset/GetNext/toyota/train.csv',
                        help='Training data path')
    parser.add_argument('--data-val',
                        type=str,
                        default='../../dataset/baseline_models_dataset/GetNext/toyota/val.csv',
    ...
    # Argument for better control of folders                        
    ...
    parser.add_argument('--save_weights',
                        type=int,
                        default=1,
                        help='To save arguments')
    parser.add_argument('--save_embeds',
                        type=int,
                        default=1,
                        help='To save embeddings')
